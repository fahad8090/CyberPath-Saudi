            ...
            <div class="footer-grid fade">
                <div class="footer-about-section">
                    ...
                    <div class="footer-social-icons">
                        <a href="https://x.com/MAFTechSA" target="_blank"><img src="${projectPath}assets/social/x.png" alt="X"></a>
                        <a href="https://instagram.com/MAFTechSA" target="_blank"><img src="${projectPath}assets/social/instagram.png" alt="Instagram"></a>
                        <a href="https://tiktok.com/@MAFTechSA" target="_blank"><img src="${projectPath}assets/social/tiktok.png" alt="TikTok"></a>
                        <a href="mailto:maftechsup@gmail.com"><img src="${projectPath}assets/social/email.png" alt="Email"></a>
                    </div>
                </div>
            ...
            <div class="footer-copyright">
                <div class="footer-accreditations">
                    <div class="accreditation-item">
                        <a href="https://freelance.sa/certificate-validation?step=nafath" target="_blank" rel="noopener noreferrer">
                            <img src="${projectPath}assets/3.png" alt="اعتماد المركز السعودي للأعمال">
                        </a>
                        <span class="badge-number">0000094109</span>
                    </div>
                    <div class="accreditation-item">
                        <a href="https://eauthenticate.saudibusiness.gov.sa/inquiry" target="_blank" rel="noopener noreferrer">
                            <img src="${projectPath}assets/4.png" alt="اعتماد منصة العمل الحر">
                        </a>
                        <span class="badge-number">FL-506721524</span>
                    </div>
                </div>
                <div class="footer-banner">
                    <img src="${projectPath}assets/5.png" alt="MAF Tech Banner">
                </div>
                جميع الحقوق محفوظة &copy; 2026 - MAF Tech
            </div>
        </div>
    </footer>`;
